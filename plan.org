...
** TODO Make the size of vertices commensurate with the number of them.
** TODO Update the video.
** TODO Make final check that all (really all) demo versions run with and without -v 0.
- Pancake with 30 pancakes and visualization seg-faults very quickly.
