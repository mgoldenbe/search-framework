...
\paragraph[{\texorpdfstring{Octile\+Heuristic(const State \&goal)}{OctileHeuristic(const State &goal)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class State $>$ {\bf slb\+::ext\+::domain\+::grid\+::\+Octile\+Heuristic}$<$ State $>$\+::{\bf Octile\+Heuristic} (
...
\paragraph[{\texorpdfstring{operator()(const State \&s) const }{operator()(const State &s) const }}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class State $>$ State\+::\+Cost\+Type {\bf slb\+::ext\+::domain\+::grid\+::\+Octile\+Heuristic}$<$ State $>$\+::operator() (
\begin{DoxyParamCaption}
\item[{const State \&}]{s}
\end{DoxyParamCaption}
