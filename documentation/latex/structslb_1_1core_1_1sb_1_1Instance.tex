...
\end{DoxyReturn}
\begin{DoxyNote}{Note}
The reference in the return value is non-\/const, since some search algorithms need to modify the set of goals as the algorithm progresses. See \hyperlink{structslb_1_1ext_1_1policy_1_1goalHandler_1_1MinHeuristic}{ext\+::policy\+::goal\+Handler\+::\+Min\+Heuristic} for an example. 
\end{DoxyNote}
