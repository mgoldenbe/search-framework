...
\index{slb\+::ext\+::explicit\+\_\+space\+::\+Grid@{slb\+::ext\+::explicit\+\_\+space\+::\+Grid}!begin\+State\+Iterator@{begin\+State\+Iterator}}
\index{begin\+State\+Iterator@{begin\+State\+Iterator}!slb\+::ext\+::explicit\+\_\+space\+::\+Grid@{slb\+::ext\+::explicit\+\_\+space\+::\+Grid}}
\paragraph[{\texorpdfstring{begin\+State\+Iterator()}{beginStateIterator()}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Cost\+Type\+\_\+$>$ template$<$class Explicit\+State $>$ {\bf State\+Iterator}$<${\bf Explicit\+State}$>$ {\bf slb\+::ext\+::explicit\+\_\+space\+::\+Grid}$<$ Cost\+Type\+\_\+ $>$\+::begin\+State\+Iterator (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [private]}}\hypertarget{structslb_1_1ext_1_1explicit__space_1_1Grid_ac672b9b4974011f4c10243a9c42e5e5e}{}\label{structslb_1_1ext_1_1explicit__space_1_1Grid_ac672b9b4974011f4c10243a9c42e5e5e}


Returns the iterator over the states of the given domain corresponding to the locations of the grid set to the state corresponding to the first location. 


\begin{DoxyTemplParams}{Template Parameters}
{\em Explicit\+State} & The type representing the given explicit domain. \\
\hline
\end{DoxyTemplParams}
\begin{DoxyReturn}{Returns}
The iterator over the states of the given domain corresponding to the locations of the grid set to the state corresponding to the first location. 
\end{DoxyReturn}
...
\index{slb\+::ext\+::explicit\+\_\+space\+::\+Grid@{slb\+::ext\+::explicit\+\_\+space\+::\+Grid}!end\+State\+Iterator@{end\+State\+Iterator}}
\index{end\+State\+Iterator@{end\+State\+Iterator}!slb\+::ext\+::explicit\+\_\+space\+::\+Grid@{slb\+::ext\+::explicit\+\_\+space\+::\+Grid}}
\paragraph[{\texorpdfstring{end\+State\+Iterator()}{endStateIterator()}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Cost\+Type\+\_\+$>$ template$<$class Explicit\+State $>$ {\bf State\+Iterator}$<${\bf Explicit\+State}$>$ {\bf slb\+::ext\+::explicit\+\_\+space\+::\+Grid}$<$ Cost\+Type\+\_\+ $>$\+::end\+State\+Iterator (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [private]}}\hypertarget{structslb_1_1ext_1_1explicit__space_1_1Grid_a6652bd758225247b7bbc741461d4bf67}{}\label{structslb_1_1ext_1_1explicit__space_1_1Grid_a6652bd758225247b7bbc741461d4bf67}


Returns the iterator over the states of the given domain corresponding to the locations of the grid set past the state corresponding to the last location. 
...
\end{DoxyTemplParams}
\begin{DoxyReturn}{Returns}
The iterator over the states of the given domain corresponding to the locations of the grid set past the state corresponding to the last location. 
\end{DoxyReturn}
...
\index{slb\+::ext\+::explicit\+\_\+space\+::\+Grid@{slb\+::ext\+::explicit\+\_\+space\+::\+Grid}!location\+Iterator@{location\+Iterator}}
\index{location\+Iterator@{location\+Iterator}!slb\+::ext\+::explicit\+\_\+space\+::\+Grid@{slb\+::ext\+::explicit\+\_\+space\+::\+Grid}}
\paragraph[{\texorpdfstring{location\+Iterator()}{locationIterator()}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Cost\+Type\+\_\+$>$ {\bf Location\+Iterator} {\bf slb\+::ext\+::explicit\+\_\+space\+::\+Grid}$<$ Cost\+Type\+\_\+ $>$\+::location\+Iterator (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [private]}}\hypertarget{structslb_1_1ext_1_1explicit__space_1_1Grid_a0136e082c52c7d3c7334b64fd69f4985}{}\label{structslb_1_1ext_1_1explicit__space_1_1Grid_a0136e082c52c7d3c7334b64fd69f4985}


Returns the iterator over the locations of the grid set to the first location. 

\begin{DoxyReturn}{Returns}
The iterator over the locations of the grid set to the first location. 
\end{DoxyReturn}
