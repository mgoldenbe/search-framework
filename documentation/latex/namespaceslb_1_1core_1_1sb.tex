...
\index{slb\+::core\+::sb@{slb\+::core\+::sb}!random\+Walk\+State@{random\+Walk\+State}}
\index{random\+Walk\+State@{random\+Walk\+State}!slb\+::core\+::sb@{slb\+::core\+::sb}}
\paragraph[{\texorpdfstring{random\+Walk\+State(const State \&s, int length, const std\+::vector$<$ State $>$ \&v)}{randomWalkState(const State &s, int length, const std::vector< State > &v)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class State $>$ State slb\+::core\+::sb\+::random\+Walk\+State (
\begin{DoxyParamCaption}
\item[{const State \&}]{s, }
\item[{int}]{length, }
\item[{const std\+::vector$<$ State $>$ \&}]{v}
\end{DoxyParamCaption}
)}\hypertarget{namespaceslb_1_1core_1_1sb_a8e97884bbdba52e74db4baf3fd5cd561}{}\label{namespaceslb_1_1core_1_1sb_a8e97884bbdba52e74db4baf3fd5cd561}


Perform a random walk of specified length from the specified state and return the resulting state. Checks that the state is not in the given vector of states. 
...
\begin{DoxyParams}{Parameters}
{\em s} & The state from which the random walk is to be initiated. \\
\hline
{\em length} & The length of the random walk. \\
\hline
{\em v} & The vector of forbidden states. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
The state resulting from a random walk of length {\ttfamily length} initiated at {\ttfamily s}. 
\end{DoxyReturn}
