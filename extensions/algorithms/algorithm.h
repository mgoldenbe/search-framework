...
/// \tparam GoalHandler_ The policy for handling goal conditions.
/// \tparam InitialHeuristic_ The intial heuristic used by the search algorithm.
/// \tparam Generator_ The generator used by the search algorithm.
