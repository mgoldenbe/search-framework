...
/// \note All the members of an index are static. An index without an inverse
/// provides only the static constexpr member \c kind of the IndexKind type, the
/// \c to function to compute an index based on step and a \c size
