...
/// only \c nKeptNines 9's none of the 0's are kept, so we get 3.99 and 3,
/// respectively. The above numbers are characterized by \c repeatLimit zeros or
/// nines.
std::string double2str(double f) {
    const int nKeptNines = 2;
    const int repeatLimit = 6;
    std::stringstream ss;
    ...
    if (point == std::string::npos)
        return s;
    std::string s9(repeatLimit, '9'), s0(repeatLimit, '0');
