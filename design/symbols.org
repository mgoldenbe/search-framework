...
I am considering using clang to do a really good job of determining the context of the undefined symbol:
- The question on tools: http://stackoverflow.com/questions/3471633/building-a-parser-with-clang
- It seems like LibTooling is what I need: http://clang.llvm.org/docs/LibTooling.html
- It seems like I want to parse a snippet of code in memory, which means using runToolOnCode.
- This is the most directly relevant answer I found: http://stackoverflow.com/a/33644235/2725810
For now, clang is too steep a learning curve. So, I decided to stick with doing things by hand.
